...
class BarakMenuScreen extends StatelessWidget {
  final List<Menu> data;

  BarakMenuScreen({required this.data});
                  ...
                  children: [
                                ...
                                Flexible(
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onEditingComplete: () {
                                        NavigationHelper.searchAsBarak(
                    ...
                    if (!NavigationHelper.isSearched ||
                      ...
                      Container(
                        ...
                        height: NavigationHelper.isFounded ? 340 : 360,
                    ...
                    BaronButton(
                      ...
                      callback: () async {
                        NavigationHelper.navigateToAddMenuScreen(context);
                      },
                      buttonWidth: null,
                    ),
                  ],
